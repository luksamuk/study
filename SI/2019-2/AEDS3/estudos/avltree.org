...
graph G {
      ...
      subgraph cluster_0 {
          ...
          LB0[label="Y", shape=triangle];
          LC0[label="Z", shape=triangle];
          RC0[label="W", shape=triangle];
      ...
      subgraph cluster_1 {
          ...
          LB1[label="Y", shape=triangle];
          LC1[label="Z", shape=triangle];
          RC1[label="W", shape=triangle];
...
#+RESULTS[f50c943960cdc363f65eb5d36b6ec1d1d98dcdee]: fig:lrot
[[file:img/lrot.svg]]
...
graph G {
      ...
      subgraph cluster_0 {
          ...
          RB0[label="Z", shape=triangle];
          LC0[label="X", shape=triangle];
          RC0[label="Y", shape=triangle];
      ...
      subgraph cluster_1 {
          ...
          RB1[label="Z", shape=triangle];
          LC1[label="X", shape=triangle];
          RC1[label="Y", shape=triangle];
...
#+RESULTS[69c3269a759fba08279274dfd74275216d4479b1]: fig:rrot
[[file:img/rrot.svg]]
