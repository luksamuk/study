# Somewhat modified from https://github.com/ABelliqueux/nolibgs_hello_worlds.
# Check this repo for many important details!
...
CPPFLAGS += -I$(THISDIR)psyq/include
LDFLAGS += -L$(THISDIR)psyq/lib
