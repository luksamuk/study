...
If you  recall from  the [[./hardware.org][Hardware]]  class, ~0x1f800000~ is  the base  address for
...
#+begin_src asm :tangle src/fillmem.s
	.psx
	.create "fillmem.bin", 0x80010000
	.org 0x80010000
...
#+begin_src asm :tangle src/fillmemw.s
	.psx
